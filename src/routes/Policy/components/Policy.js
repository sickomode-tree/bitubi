    ...
    return (
      <div>
        ...
        <p>
          ...
          обеспечению безопасности персональных данных ООО "БИТУБИ" (далее –
          Оператор).
        </p>
        <ol>
          <li>
          ...
          <li>
            ...
            может получить о посетителях веб-сайта http://bitubi.ru.
          </li>
        </ol>
        ...
        <ol>
          ...
          <li>
            ...
            интернет по сетевому адресу http://bitubi.ru;
          </li>
          <li>
          ...
          <li>
            ...
            к определенному или определяемому Пользователю веб-сайта http://bitubi.ru;
          </li>
          <li>
            Пользователь – любой посетитель веб-сайта http://bitubi.ru;
          </li>
          <li>
          ...
          <li>
            ...
            в средствах массовой информации, размещение в информационнотелекоммуникационных
        ...
        <ol>
          ...
          <li>
            ...
            почты bitubi.spb@yandex.ru с пометкой «Отказ от уведомлениях о новых
        ...
        <ol>
          <li>
            ...
            специальные формы, расположенные на сайте http://bitubi.ru. Заполняя
        ...
        <ol>
          ...
          <li>
            ...
            уведомление на адрес электронной почты Оператора bitubi.spb@yandex.ru с
          ...
          <li>
            ...
            электронной почты на электронный адрес Оператора bitubi.spb@yandex.ruс
        ...
        <ol>
          <li>
            ...
            Оператору с помощью электронной почты bitubi.spb@yandex.ru.
          </li>
          <li>
          ...
          <li>
            ...
            Интернет по адресу http://bitubi.ru.
          </li>
        </ol>
      </div>
    )
